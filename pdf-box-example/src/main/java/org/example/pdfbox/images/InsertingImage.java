...
public class InsertingImage {
    public static void main(String args[]) throws Exception {
        ...
        File image = new File("src/main/resources/data/icon.png");
...
//        Rectangle2D humanRect = new Rectangle2D.Float(100, 300, 250, 100);
...
//            doc.save("src/main/resources/data/sample-with-image2.pdf");
            doc.save(baos);
